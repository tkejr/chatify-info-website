...
<header>
      <div className="relative bg-black px-4 md:px-10">
        <div className="flex flex-row items-start justify-between gap-x-4 py-3 md:pt-4">
          ...
          <div className="w-fit items-center justify-center gap-x-2 rounded-lg p-1 backdrop-blur-md md:flex md:place-self-end md:rounded-xl">
            <a
              href="#"
              className="hidden rounded-lg px-3 py-2 text-secondary/80 transition-colors hover:bg-secondary/10 md:flex"
              target="_blank"
            >
              Community
            </a>
            <a
              href="#"
              className="mr-2 hidden rounded-lg px-3 py-2 text-secondary/80 transition-colors hover:bg-secondary/10 md:flex"
            >
              Contact
            </a>
          </div>
